...
class ViewRepository extends ServiceEntityRepository
{
    ...
    /**
     * Indique si l'utilisateur a deja une vue enregistree sur ce manga durant la journee donnee.
     * Sert a dedupliquer les vues pour ne pas en creer une a chaque rechargement de page.
     */
