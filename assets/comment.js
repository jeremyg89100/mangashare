function addComment() {
    ...
    const form = document.querySelector(".form-info-manga");
    ...
    if (form) {
        form.addEventListener("submit", (event) => {
            ...
            const pseudo = form.dataset.userPseudo;
...
function showComments(pseudo, date, content, miniature) {
    const commentList = document.querySelector(".manga-comment-list");
    ...
    commentInfo.append(avatarContainer, pseudoContainer, dateContainer);
